...
const radioTarget = `                      {/* Subscribe to Play Episodes */}`;

const radioInjection = `                      {/* Global Live Stations */}
...
// Use simple indexOf logic to patch
let newContent = content;

if (newContent.includes(newPageTarget.trim())) {
  newContent = newContent.replace(newPageTarget.trim(), newPageInjection + '\\n' + newPageTarget.trim());
  console.log("Patched New Page");
} else {
  console.log("Target for New Page not found");
}

if (newContent.includes(radioTarget.trim())) {
  newContent = newContent.replace(radioTarget.trim(), radioInjection + '\\n' + radioTarget.trim());
  console.log("Patched Radio Page");
} else {
  console.log("Target for Radio Page not found");
}
