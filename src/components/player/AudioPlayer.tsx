...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({ 
 ...
 return 'text-ink-secondary bg-[#181818] border-white/10';
 };
 ...
 className={`w-full flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-colors ${quality === q ? 'bg-teal/20 text-teal font-bold' : 'text-silver hover:bg-[#242424]'}`}
 >
 ...
 exit={{ y: '100%' }}
 transition={{ type: 'spring', damping: 25, stiffness: 200 }}
 className="absolute inset-0 z-20 bg-black p-6 flex flex-col"
 ...
 <div className="flex items-center gap-3 p-3 bg-[#242424] rounded-xl mb-4">
 ...
 {/* Desktop Full Player */}
 {!isMobile && (
 <div className="flex items-center gap-4 px-6 py-2.5 bg-[#2c2c2c] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] rounded-full relative z-40 mx-auto w-max max-w-[95vw] transition-all">
 ...
 <div className="w-1 h-1 bg-[#333333] rounded-full" />
 </div>
 </div>
 ...
 {false && (
 <span className="text-[8px] bg-[#333333] text-white px-1 py-0.5 rounded-sm font-bold uppercase leading-none">E</span>
 )}
 </div>
 ...
 <button onClick={() => handleQualitySelect('128k')} className="w-full flex items-center justify-between px-2 py-1.5 text-[10px] text-white hover:bg-[#242424] rounded-lg text-left cursor-pointer">
 <span>Preview (128kbps)</span>
 {quality === '128k' && <Check className="w-3 h-3 text-white" />}
 </button>
 <button onClick={() => handleQualitySelect('320k')} className="w-full flex items-center justify-between px-2 py-1.5 text-[10px] text-white hover:bg-[#242424] rounded-lg text-left cursor-pointer">
 ...
 <button onClick={() => handleQualitySelect('flac')} className="w-full flex items-center justify-between px-2 py-1.5 text-[10px] text-white hover:bg-[#242424] rounded-lg text-left cursor-pointer">
 ...
 className="absolute bottom-full right-0 mb-6 w-72 max-h-80 bg-[#2c2c2c] border border-white/10 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden z-50 origin-bottom-right"
 >
 <div className="p-3 border-b border-white/10 flex justify-between items-center bg-[#181818]">
 <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
 <ListMusic className="w-3.5 h-3.5" /> Up Next
 </h3>
 <span className="text-[10px] text-slate-300 bg-[#242424] px-2 py-0.5 rounded-full">{queue.length} track{queue.length !== 1 && 's'}</span>
 </div>
 ...
 className="flex items-center gap-3 p-2 hover:bg-[#242424] rounded-xl group transition-all cursor-pointer border border-transparent hover:border-white/10 relative"
 >
 ...
 className="w-24 accent-white h-1 bg-[#333333] rounded-lg appearance-none cursor-pointer"
 />
 </div>
 </div>
 ...
 className="fixed inset-0 z-[150] bg-black flex flex-col md:flex-row overflow-hidden"
 >
 <button 
